       ...
       <script>
            function validation(){
                ...
                if(password != password2){
                    ...
                    document.getElementById("error").innerHTML = "Password's length should be between 8 and 15(both inclusive)!";
                    k = false;
                    check = 1;
                }
...
<div class="col-md-4 center"></div>
            ...
            <div class="col-md-4 right"><a href="https://www.facebook.com/ifestdaiict/" target="_blank"><img src="assets/img/logo.png" alt="ifest'18 Logo" width="20%" style="padding:10px 0px 0px 0px"></a></div>
         </div>


         <div style="color:white" class="col-md-offset-3 col-md-6">
                        <h1 style="color:white" ><strong>i.Decipher 2018</strong></h1>
